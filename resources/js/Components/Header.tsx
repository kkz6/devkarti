                    ...
                    >
                        ...
                        >
                            <svg
                                ...
                                className={`menu-icon h-6 w-6 scale-125 fill-skin-base transition-transform duration-300 ${
                        ...
                        >
                            ...
                            {SITE.lightAndDarkMode && (
                                <li className="col-span-1 flex items-center justify-center">
                                    <button
                                        id="theme-btn"
                                        className="focus-outline p-3 sm:p-1 transition-transform duration-300 hover:scale-110 relative"
                                    ...
                                    >
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            id="moon-svg"
                                            className={`h-6 w-6 fill-skin-base hover:fill-skin-accent transition-all duration-300 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 ${
                                                theme === "light" ||
                                                (theme === "auto" &&
                                                    !window.matchMedia(
                                                        "(prefers-color-scheme: dark)"
                                                    ).matches)
                                                    ? "scale-125 rotate-0 opacity-100 sm:scale-100"
